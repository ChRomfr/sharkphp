<?php /* Smarty version Smarty-3.1.13, created on 2013-03-19 17:14:52
...
<link rel="alternate" type="application/rss+xml" title="News" href="<?php echo $_smarty_tpl->tpl_vars['Helper']->value->getLink("xml/fluxRSSNews?nohtml");?>
" />
<link rel="alternate" type="application/rss+xml" title="Tutoriaux" href="<?php echo $_smarty_tpl->tpl_vars['Helper']->value->getLink("xml/fluxRSSArticle?nohtml");?>
" />
<link rel="alternate" type="application/rss+xml" title="Telechargement" href="<?php echo $_smarty_tpl->tpl_vars['Helper']->value->getLink("xml/fluxRSSDownload?nohtml");?>
" />
...
<?php echo $_smarty_tpl->tpl_vars['config']->value['url_dir'];?>
web/images/sharkphp_white.png" alt="Sharkphp" /></a><div class="nav-collapse"><ul class="nav"><li><a href="<?php echo $_smarty_tpl->tpl_vars['Helper']->value->getLink("index");?>
"><i class="icon-home icon-white"></i></a></li><li><a href="<?php echo $_smarty_tpl->tpl_vars['Helper']->value->getLink("article");?>
" title="Tutoriaux">Tutoriaux</a></li><li><a href="<?php echo $_smarty_tpl->tpl_vars['Helper']->value->getLink("download");?>
" title="Telechargement">Telechargement</a></li><li><a href="<?php echo $_smarty_tpl->tpl_vars['Helper']->value->getLink("contact");?>
...
<?php echo $_smarty_tpl->tpl_vars['config']->value['url_dir'];?>
adm/" title="Administration"><i class="icon-wrench icon-white"></i></a></li><?php }?></ul><?php if ($_SESSION['utilisateur']['id']=='Visiteur'){?><form class="navbar-form pull-right" method="post" action="<?php echo $_smarty_tpl->tpl_vars['Helper']->value->getLink("connexion");?>
...
</li></ul></div><!-- /span4 --></div><!-- /row-fluid --><hr/><div class="fleft"><a href="<?php echo $_smarty_tpl->tpl_vars['Helper']->value->getLink("xml/fluxRSSNews?nohtml");?>
