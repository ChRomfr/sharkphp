...
abstract class AdmDownloadController extends Controller{
	...
	public function addAction(){
		...
		if( $this->registry->HTTPRequest->postExists('download') ):
			...
			return $this->redirect( getLinkAdm('download'), 3, $this->lang['Telechargement_ajoute']);
		endif;
	 ...
	 public function editAction($id){
		...
		if( $this->registry->HTTPRequest->postExists('download') ){		
			...
			return $this->redirect(getLinkAdm('download'), 3, $this->lang['Telechargement_modifie']);
		}
	...
	public function deleteAction($id){
		...
		return $this->redirect(getLinkAdm('download'), 3, $this->lang['Telechargement_supprime']);
	}
