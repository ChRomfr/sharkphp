...
abstract class AdmLinkController extends Controller{
	...
	public function addAction(){
		...
		if( $this->app->HTTPRequest->postExists('link') ):
			...
			return $this->redirect( getLinkAdm('link'), 3, 'Lien enregistré');
		endif;
	 ...
	 public function editAction($id){
		...
		if( $this->app->HTTPRequest->postExists('link') ){	
			...
			return $this->redirect( getLinkAdm('link'), 3, 'Lien modifié');
		}
	...
	public function deleteAction($id){
		...
		return $this->redirect(getLinkAdm('link'), 3, 'Lien supprimé');
	}
