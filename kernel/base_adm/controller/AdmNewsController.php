...
abstract class AdmNewsController extends Controller{
	...
	public function addAction(){
		...
		if( $this->app->HTTPRequest->postExists('news') ){
			...
			return $this->redirect(getLinkAdm('news'), 3, $this->lang['News_ajoutee']);
		}
	...
	public function editAction($id){
		...
		if( $this->app->HTTPRequest->postExists('news') ){
			...
			return $this->redirect(getLinkAdm('news'), 3, $this->lang['News_modifiee']);
		}
	...
	public function deleteAction($id){
		...
		return $this->redirect(getLinkAdm('news'), 3, $this->lang['News_supprimee']);
	}
}